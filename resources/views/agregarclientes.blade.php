...
<html lang="{{ app()->getLocale() }}">
    ...
    -->
            ...
            <div class="content">
                ...
                <br>
    <center>
        <form action="/ingresoclientes" method="POST">
        
            {{csrf_field()}}

            <label>Identificación *</label>
            <input type="text" name="iden_clie" placeholder="C.C.">
            <br>
            <br>
            <label>Primer Nombre *</label>
            <input type="text" name="pnom_clie" placeholder="Nombre...">
            <label>Segundo Nombre</label>
            <input type="text" name="snom_clie">
            <br>
            <br>
            <label>Primer Apellido *</label>
            <input type="text" name="pape_clie" placeholder="Apellido..">
            <label>Segundo Apellido</label>
            <input type="text" name="sape_clie">
            <br>
            <br>
            <label>Correo electrónico</label>
            <input type="text" name="emai_clie" placeholder="eje@mail.com">
            <label>Dirección</label>
            <input type="text" name="dire_clie" placeholder="Cl 40 KR 56 78.">
            <br>
            <br>
            <button type="submit" class="btn btn-info">Agregar</button>
                <a href="/verclientes"><input type="button" class="btn btn-warning" value="ver"></a>
        </form>
        <br>
